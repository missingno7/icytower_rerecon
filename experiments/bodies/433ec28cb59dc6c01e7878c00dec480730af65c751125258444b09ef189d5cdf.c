{
    ...
    if (!blit_mode) {                                          /* 2282 */
        ...
        int x, y;
        if (ply[player_id]->x - 160.0 <= 0.0) x = 0;
        else if (ply[player_id]->x - 160.0 > 320.0) x = 320;
        else x = (int)(ply[player_id]->x - 160.0);
        if (ply[player_id]->y - 160.0 <= 0.0) y = 0;
        else if (ply[player_id]->y - 160.0 > 240.0) y = 240;
        else y = (int)(ply[player_id]->y - 160.0);
        stretch_blit(bmp, screen, x, y, 320, 240, 0, 0, 640, 480); /* 2307 */
    }
    else if (blit_mode == 6) {                                 /* 2309 */
        int x, y;
        if (ply[player_id]->x - 80.0 <= 0.0) x = 0;
        else if (ply[player_id]->x - 80.0 > 520.0) x = 520;
        else x = (int)(ply[player_id]->x - 80.0);
        if (ply[player_id]->y - 80.0 <= 0.0) y = 0;
        else if (ply[player_id]->y - 80.0 > 360.0) y = 360;
        else y = (int)(ply[player_id]->y - 80.0);
