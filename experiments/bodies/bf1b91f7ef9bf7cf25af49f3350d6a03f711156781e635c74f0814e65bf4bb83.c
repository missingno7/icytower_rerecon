{
    ...
    initial = r->biggest_lost_combo * 17 + 17;
    initial += r->no_combo_top_floor * 127;
    subtotal = r->floor_size * 17 + r->floor_shrink * 102 + 3702;
    subtotal += r->start_speed * 163 + r->speed_increase * 23;
    subtotal += r->gravity * 88;
    sum = subtotal + initial * 2;
    sum += r->random_seed * 329;
