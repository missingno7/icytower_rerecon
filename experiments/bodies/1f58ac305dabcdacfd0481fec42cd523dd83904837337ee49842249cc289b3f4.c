{
    ...
    if (!blit_mode) {                                          /* 2282 */
        ...
        if (delta > 0.0) {`n            if (delta > 320.0) x = 320;`n            else x = (int)delta;`n        } else x = 0;
        delta = ply[player_id]->y - 160.0;
        if (delta > 0.0) {`n            if (delta > 240.0) y = 240;`n            else y = (int)delta;`n        } else y = 0;
        ...
        if (delta > 0.0) {`n            if (delta > 520.0) x = 520;`n            else x = (int)delta;`n        } else x = 0;
        delta = ply[player_id]->y - 80.0;
        if (delta > 0.0) {`n            if (delta > 360.0) y = 360;`n            else y = (int)delta;`n        } else y = 0;
