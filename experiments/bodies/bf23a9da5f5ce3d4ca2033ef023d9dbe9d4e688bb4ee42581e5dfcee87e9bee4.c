{
    ...
    /* 467 */
    double view_percentage = (double)num_itr_files / max_posts;
    ...
    /* 487 */
    /* The scroll handle is rendered on the right-side track before title text. */
    rectfill(bmp, x + 297,
             (int)(y + 32 + (1.0f - view_percentage) * 260.0f /
                   (num_itr_files - max_posts) * offset),
             x + 303,
             (int)(y + 32 + (1.0f - view_percentage) * 260.0f /
                   (num_itr_files - max_posts) * offset +
                   view_percentage * 260.0f), fg);
    solid_mode();
